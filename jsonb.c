...
PG_FUNCTION_INFO_V1(jsonb_out);
PG_FUNCTION_INFO_V1(jsonb_populate_record);
PG_FUNCTION_INFO_V1(jsonb_populate_recordset);
PG_FUNCTION_INFO_V1(jsonb_recv);
PG_FUNCTION_INFO_V1(jsonb_send);
PG_FUNCTION_INFO_V1(jsonb_to_record);
PG_FUNCTION_INFO_V1(jsonb_to_recordset);
PG_FUNCTION_INFO_V1(jsonb_typeof);
PG_FUNCTION_INFO_V1(gin_extract_jsonb);
PG_FUNCTION_INFO_V1(gin_extract_jsonb_hash);
PG_FUNCTION_INFO_V1(gin_extract_jsonb_query);
PG_FUNCTION_INFO_V1(gin_extract_jsonb_query_hash);
PG_FUNCTION_INFO_V1(gin_consistent_jsonb);
PG_FUNCTION_INFO_V1(gin_consistent_jsonb_hash);
